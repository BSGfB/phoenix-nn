...
from src.util.ModelsUtil import createCnnModel, createBigCnnModel, VGG_11, VGG_16, VGG_19, myVGG_11
...
model, history, score = start(model=myVGG_11(input_shape, num_classes),
                              data=data,
